 ...
 * Include Files
 *----------------------------------------------------------------------------*/
#include "./capi/inc/capi_control_tx.h"
#include "spf/test/test_capi/inc/capi_entry_function_externs.h"

capi_err_t (*capi_entry_get_static)(capi_proplist_t *, capi_proplist_t *) = &capi_control_tx_get_static_properties;
capi_err_t (*capi_entry_init)(capi_t *, capi_proplist_t *)                = &capi_control_tx_init;

...
// clang-format off
/*
$Header: //source/qcom/qct/platform/adsp/proj/addons_audio/spf/incs/api/modules/media_fmt_api_basic.h#3 $
*/
// clang-format on
...
/** @ingroup ar_spf_mod_media_fmt_ids
    ...
    This parameter ID is set via APM_CMD_SET_CFG (see the AudioReach SPF
    API Reference (80-VN500-5)). It is accepted only when the subgraph is
...
/*# @h2xmlp_parameter   {"PARAM_ID_MEDIA_FORMAT", PARAM_ID_MEDIA_FORMAT}
    ...
    @h2xmlp_description {ID for the parameter used to set the media format on
                         ...
                         is set via APM_CMD_SET_CFG (see the AudioReach SPF
                         API Reference (80-VN500-5)). It is accepted only

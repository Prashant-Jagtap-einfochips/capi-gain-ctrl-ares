...
typedef enum {
   ...
   POSAL_MEMORYMAP_EBI1_POOL,                              /**< EBI1 pool. */
 ...
 *safety.
 */
ar_result_t posal_memorymap_util_region_delete(posal_memorymap_node_t *mem_map_node_ptr);
...
*/
void posal_memorymap_global_unmap_all(void);

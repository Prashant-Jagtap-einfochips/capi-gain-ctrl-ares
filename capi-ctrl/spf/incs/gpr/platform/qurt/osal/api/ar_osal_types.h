...
#define __UNREFERENCED_PARAM(x)                                                                                        \
   (x) /*UNREFERENCED_PARAMETER is not used here, getting conflict including windows.h with INFINITE redefined in      \
          (media_fmt_api.h)*/
#define __UNUSED
...
#endif /* __H2XML__ */
#endif /* #ifndef CASA_OSAL_TYPES_H */

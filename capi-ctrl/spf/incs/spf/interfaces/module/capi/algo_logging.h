 ...
 *
 */
ar_result_t algo_data_logging_init(algo_data_logging_t **algo_data_logging_pptr);
 ...
 *  	 pointer
 * @return mm_result_t, retuns success or failure
 *
 */
ar_result_t algo_data_logging_register(algo_data_logging_t *algo_data_logging_ptr,
 ...
 *
 */
ar_result_t algo_data_logging_deregister(algo_data_logging_t *algo_data_logging_ptr, uint32_t client_handle);
 ...
 *  
 */
ar_result_t algo_data_log_now(algo_data_logging_t *algo_data_logging_ptr,
                             int8_t *log_buffer,
                             uint32_t log_size,
 ...
 * 
 */
ar_result_t algo_log_status(uint32_t log_code);
...
ar_result_t algo_log_alloc(void **log_ptr, uint32_t log_code, uint32_t buf_size);
...
ar_result_t algo_log_buffer(void *log_ptr, uint32_t log_tap_id, uint32_t session_id, uint32_t buf_size);

...
// clang-format off
/*
$Header: //source/qcom/qct/platform/adsp/proj/addons_audio/spf/incs/spf/interfaces/module/capi/adv/capi_fwk_extns_sync.h#3 $
*/
// clang-format on
...
/** Unique identifier of the framework extension for the Synchronization module, which
    ...
    - #FWK_EXTN_SYNC_PARAM_ID_PORT_WILL_START @newpage
*/
...
/** @weakgroup fwk_extn_sync_event_id_data_port_activity_state_t
@{ */

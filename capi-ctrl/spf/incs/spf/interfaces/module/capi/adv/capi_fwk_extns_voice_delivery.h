...
// clang-format off
/*
$Header: //source/qcom/qct/platform/adsp/proj/addons_audio/spf/incs/spf/interfaces/module/capi/adv/capi_fwk_extns_voice_delivery.h#3 $
*/
// clang-format on
...
/* Custom param id to inform the voice delivery module of the container's reception
   of the VFR resync. This param has no payload. */
#define FWK_EXTN_VOICE_DELIVERY_PARAM_ID_RESYNC_NOTIF 0x0A001055

/* Custom param id to inform the voice delivery module that there was upstream
   data drop which occurred while the voice delivery module is in syncing state.
 */
...
/** ID of the event the Voice Delivery module raises to inform VCPM if the
    module is inputs are synced or not yet synced.

   @msgpayload{fwk_extn_voice_delivery_event_update_sync_state_t}
   @table{weak__fwk__extn_voice__delivery__event__update__sync__state__t} @newpage
 */
...
/** @weakgroup fwk_extn_voice_delivery_event_update_sync_state_t
@{ */

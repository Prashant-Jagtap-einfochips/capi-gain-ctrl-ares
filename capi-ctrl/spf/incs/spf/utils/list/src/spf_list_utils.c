...
{
   uint32_t handle = posal_bufpool_pool_create(sizeof(spf_list_node_t), heap_id, num_arrays, FOUR_BYTE_ALIGN);
   ...
   AR_MSG(DBG_FATAL_PRIO, "Created List Pool - heap_id = %lu, Handle 0x%lx", heap_id, handle);
}

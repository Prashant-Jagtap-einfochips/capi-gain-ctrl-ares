...
// clang-format off
/*
$Header: //source/qcom/qct/platform/adsp/proj/addons_audio/spf/incs/spf/interfaces/module/capi/adv/capi_fwk_extns_dm.h#3 $
*/
// clang-format on
...
/** ID of the parameter used to inform the dm module whether it should consume
    ...
    amount is provided. When less than expected input is provided, this module is allowed to produce for any
    ...
    when less than expected input is provided.
    @newpage

...
// clang-format off
/*
$Header: //source/qcom/qct/platform/adsp/proj/addons_audio/spf/incs/api/modules/detection_cmn_api.h#3 $
*/
// clang-format on
...
#include "spf_end_pack.h"
;
typedef struct param_id_detection_engine_register_multi_sound_model_t
...
#include "spf_end_pack.h"
;
typedef struct param_id_detection_engine_deregister_multi_sound_model_t
...
/* Unique Parameter id */
#define PARAM_ID_DETECTION_ENGINE_DUMMY_GLOBAL_PERSIST_PARAM 0x08001230
/*==============================================================================
   Type definitions
==============================================================================*/

/** @h2xmlp_emptyParameter {"PARAM_ID_DETECTION_ENGINE_DUMMY_GLOBAL_PERSIST_PARAM",
                            PARAM_ID_DETECTION_ENGINE_DUMMY_GLOBAL_PERSIST_PARAM}
    @h2xmlp_description    {Registers a global persistent param with module. \n
           \n
           -Dummy global persistent parameter
           for the module. \n
           \n
           -This paramter must be registered by using the
            APM_CMD_REGISTER_CFG in a global persistent
            payload only. \n
           \n
           -All calibration parameters start from a 4-byte aligned address.
           This parameter for this module has an additional 8-byte alignment
...
#include "spf_end_pack.h"
;
typedef struct param_id_detection_engine_multi_model_buffering_config_t
